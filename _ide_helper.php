...
namespace {
    ...
    class BaseFunction extends \App\Semi\BaseFunction\Facades\BaseFunction{
         ...
         * @static 
         */
        public static function result($success = true, $message = array(), $action = false){
            return \App\Semi\BaseFunction\BaseFunctionManager::result($success, $message, $action);
        }
        ...
        public static function decodeInput($request){
            return \App\Semi\BaseFunction\BaseFunctionManager::decodeInput($request);
        }
        ...
        public static function dataTable($tbData, $countFilter, $countTotal, $canEdit = true){
            return \App\Semi\BaseFunction\BaseFunctionManager::dataTable($tbData, $countFilter, $countTotal, $canEdit);
        }
        ...
        public static function getErrorMessage(){
            return \App\Semi\BaseFunction\BaseFunctionManager::getErrorMessage();
        }
        ...
        public static function getRandomColor(){
            return \App\Semi\BaseFunction\BaseFunctionManager::getRandomColor();
        }
        ...
        public static function getBranchId(){
            return \App\Semi\BaseFunction\BaseFunctionManager::getBranchId();
        }
        ...
        public static function getUserId(){
            return \App\Semi\BaseFunction\BaseFunctionManager::getUserId();
        }
        ...
        public static function isOrganizer(){
            return \App\Semi\BaseFunction\BaseFunctionManager::isOrganizer();
        }
        ...
        public static function hasRole($role){
            return \App\Semi\BaseFunction\BaseFunctionManager::hasRole($role);
        }
        ...
        public static function destroy($obj, $model = 'entity', $errorMsg = null){
            return \App\Semi\BaseFunction\BaseFunctionManager::destroy($obj, $model, $errorMsg);
        }
        ...
        public static function store($params){
            return \App\Semi\BaseFunction\BaseFunctionManager::store($params);
        }
        ...
        public static function update($params){
            return \App\Semi\BaseFunction\BaseFunctionManager::update($params);
        }
        ...
        public static function storeOrUpdate($params){
            return \App\Semi\BaseFunction\BaseFunctionManager::storeOrUpdate($params);
        }
        ...
        public static function getDataTable($sql, $model = 'entity', $processData = null){
            return \App\Semi\BaseFunction\BaseFunctionManager::getDataTable($sql, $model, $processData);
        }
        
    }


    class BF extends \App\Semi\BaseFunction\Facades\BaseFunction{
